  ...
  extends ReportsPage
{
  public static void menuLink(PrintWriter printWriter, int runCount)
  {
    ...
    if (runCount == 1) {
      printWriter.println("\n <li class=\"menuStyle\"><a href=\"" + Directory.RUNName + runCount + Directory.SEP + "CurrentRun.html\" >" + "Run " + runCount + " (" +Directory.getTestRunDateTime(runCount) + ") </a></li>\n");
    } else {
      for (int i = 1; i <= runCount; i++)
      {
        if (i == runCount)
        {
          printWriter.println("\n <li style=\"padding-top: 4px;padding-bottom: 4px;\"><a href=\"" + Directory.RUNName + i + Directory.SEP + "CurrentRun.html\" >" + "Run " + i +" ("+ Directory.getTestRunDateTime(i) + ") </a></li>\n");
          break;
        }
        printWriter.println("\n <li class=\"menuStyle\"><a href=\"" + Directory.RUNName + i + Directory.SEP + "CurrentRun.html\" >" + "Run " +   i +" ("+ Directory.getTestRunDateTime(i) + ") </a></li>\n");
      }
    }
    printWriter.println("\n                    </ul>\n                </td>\n\n");
  }
