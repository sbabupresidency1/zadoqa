...
public class HTMLDesignFilesJSWriter {
    ...
    public static void pieChartJS(int passedSize, int failedSize, int skippedSize,
	    int paramInt4) {
	try {
    ...
    public static void barChartJS(String passed, String failed,
	    String skipped, int runCount) {
    ...
    public static void lineChartJS(String passedTest, String failedTest,
	    String skippedTest, int runCount) {
